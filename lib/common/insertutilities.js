...
(function (insertutilities) {
    ...
    function insertISODate() {
        ...
        }, function (up) { return expressionprocessor_1.ep.ISODate(); });
    }
    ...
    function insertISOTimeDate() {
        utilitymanager_1.um.utilityManager({
            utilType: utilitymanager_1.um.TIXUtilityType.utInsertAtEndUtility,
        }, function (up) { return expressionprocessor_1.ep.ISOTimeDate(); });
    }
    ...
    function insertUUID() {
        utilitymanager_1.um.utilityManager({
            utilType: utilitymanager_1.um.TIXUtilityType.utInsertAtEndUtility,
        }, function (up) { return expressionprocessor_1.ep.uuidv4(); });
    }
